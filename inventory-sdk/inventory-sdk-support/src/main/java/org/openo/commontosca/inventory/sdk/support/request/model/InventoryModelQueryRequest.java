...
public class InventoryModelQueryRequest extends AbstractInventoryRequest<Query, QueryResult>
    implements Query {

  private String modelName;

  public InventoryModelQueryRequest(Inventory inventory) {
    super(inventory);
  }

  @Override
  public InventoryModelQueryRequest byName(String modelName) {
