...
CREATE TABLE t_lcm_defPackage_mapping ( 
	...
	CONSTRAINT t_lcm_defPackage_mapping01 FOREIGN KEY (serviceId) REFERENCES t_lcm_servicebaseinfo (serviceId)
); 
...
CREATE TABLE t_lcm_inputParam_mapping ( 
	...
	CONSTRAINT t_lcm_inputParam_mapping01 FOREIGN KEY (serviceId) REFERENCES t_lcm_servicebaseinfo (serviceId)
); 
