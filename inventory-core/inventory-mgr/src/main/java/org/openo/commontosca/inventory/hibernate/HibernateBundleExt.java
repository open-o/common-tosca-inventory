...
public class HibernateBundleExt extends HibernateBundle<InventoryAppConfiguration> {
   ...
   */
  public final void runExt(InventoryAppConfiguration configuration, Environment environment)
      throws Exception {
