 ...
 */
package org.openo.commontosca.inventory.core.request;
...
public interface InventoryRawRequest<T, R> extends InventoryRequest<T, R> {

  public T collection(String collectionName);

  public String getCollection();

  public interface BulkInsert
      extends InventoryRawRequest<BulkInsert, BulkInsertResult>, WriteOperation {
     ...
     * @return
     */
    public BulkInsert failsTo(List<Map<String, Object>> fails);

    public ValueList getFailsTo();

    public ValueList getValues();

    public BulkInsert value(List<Map<String, Object>> datas);

  }

  public interface Count
      extends InventoryFilterable<Count>, InventoryRawRequest<Count, CountResult>, ReadOperation {

  }

  public interface Delete extends InventoryFilterable<Delete>,
      InventoryRawRequest<Delete, DeleteResult>, WriteOperation {

  }

  public interface Insert extends InventoryRawRequest<Insert, InsertResult>, WriteOperation {
  ...
  public interface Query
      extends InventoryFilterable<Query>, InventoryRawRequest<Query, QueryResult>, ReadOperation {
  ...
  public interface Update extends InventoryFilterable<Update>,
      InventoryRawRequest<Update, UpdateResult>, BaseUpdate<Update>, WriteOperation {
