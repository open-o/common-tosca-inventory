...
set class_path=%RUNHOME%;%RUNHOME%inventory-service.jar
echo ### jvm_opts: %jvm_opts%
echo ### class_path: %class_path%

%JAVA% -classpath %class_path% %jvm_opts% org.openo.commontosca.inventory.InventoryApp server %RUNHOME%conf/inventory.yml
